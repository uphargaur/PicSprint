...
import com.uphar.bussiness.domain.Utils.networkException.NoConnectivityException
import com.uphar.picsprint.R
...
fun setClickableHighLightedText(
    ...
    val clickableSpan: ClickableSpan = object : ClickableSpan() {
        ...
        override fun updateDrawState(ds: TextPaint) {
            ...
            ds.color = tv.context.resources.getColor(R.color.white)
